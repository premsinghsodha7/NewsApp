        ...
        if (response.isSuccessful){
            response.body()?.let{resultResponse ->
                ...
                if (breakingNewsRespose == null){
                    ...
                    val oldArticles = breakingNewsRespose?.articles
                    val newArticles = resultResponse.articles
                    oldArticles?.addAll(newArticles)
                }
                return Resource.Success(breakingNewsRespose ?: resultResponse)
            }
        }
        ...
        if (response.isSuccessful){
            response.body()?.let{resultResponse ->
                ...
                if (searchNewsRespose == null){
                    ...
                    val oldArticles = searchNewsRespose?.articles
                    val newArticles = resultResponse.articles
                    oldArticles?.addAll(newArticles)
                }
                return Resource.Success(searchNewsRespose?: resultResponse)
            }
        }
        return Resource.Error(response.message())
    }
